...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='lwx512', help='name of the experiment. It decides where to store samples and models')        
        self.parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        self.parser.add_argument('--checkpoints_dir', type=str, default='src/pix2pixHD/checkpoints', help='models are saved here')
        ...
        self.parser.add_argument('--label_nc', type=int, default=16, help='# of input label channels')
        ...
        # for AlphaPose
        self.parser.add_argument('-C', '--video', dest='video',
                    help='video-name', default="mp.mp4")      
